...
ModsDotGroovy.make {
    ...
    mod {
        modId = 'quiltgroovywrapper_wrapper'
        version = this.version
        group = this.group
        displayName = 'Quilt Groovy Wrapper: Wrappers'
        description = 'Wrapper module for Quilt Groovy Wrapper'
        author 'Luke Bemish'
        ...
        dependencies {
            ...
            quiltgroovywrapper_core = ">=${this.version}"
        }
